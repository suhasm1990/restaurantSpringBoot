(function ($) {
  ...
  var ProductManager = (function () {
    ...
    */
    ...
    var addProduct = function (id, name, summary, price, quantity) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
    ...
    */
    ...
    var setProduct = function (id, name, summary, price, quantity) {
      ...
      if (!updatePoduct(id)) {
        addProduct(id, name, summary, price, quantity);
      }
    };
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (options.cartItems && options.cartItems.constructor === Array) {
      ...
      $.each(options.cartItems, function () {
        ProductManager.setProduct(this.id, this.name, this.summary, this.price, this.quantity);
      });
    }
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-primary ' + classCheckoutCart + '">Confirm and Pay</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    */
    ...
    $(document).on('click', targetSelector, function () {
      ...
      ProductManager.setProduct(id, name, summary, price, quantity);
      $cartBadge.text(ProductManager.getTotalQuantity());
